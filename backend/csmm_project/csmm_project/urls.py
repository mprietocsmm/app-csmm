...
from csmm_app.endpoints import endpoints, comunicaciones, launcher, perfil, login, inicio, ajustes, llavero, asignaturas, ip
...
urlpatterns = [
    ...
    path('asignaturas', asignaturas.asignaturas),
    path('ip', ip.get_ip_address)
]